...
public class NexacroLargeDataController {
	private static final Logger log = LoggerFactory.getLogger(NexacroLargeDataController.class);
	
    @Resource(name = "largeDataService")
    private NexacroLargeDataService largeDataService;
    
    @Resource(name = "largeDataJdbcService")
    private NexacroLargeDataService largeDataJdbcService;
    
    @Resource(name = "largeDataMybatisService")
    private NexacroLargeDataService largeDataMybatisService;
