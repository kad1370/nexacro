 ...
 */
@Controller
public class NexacroMybatisController {
	private Logger logger = LoggerFactory.getLogger(NexacroMybatisController.class);
	
    @Resource(name = "sampleMybatisService")
    private NexacroSampleService sampleMybatisService;
