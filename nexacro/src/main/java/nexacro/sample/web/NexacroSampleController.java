 ...
 */
@Controller
public class NexacroSampleController {
	private Logger log = LoggerFactory.getLogger(NexacroSampleController.class);
	
    @Resource(name = "nexacroSampleService")
    // Name 정의
    private NexacroSampleService nexacroSampleService;
