    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("다중 데이터 조회 샘플");
            ...
            obj.set_taborder("29");
            this.div_search.addChild(obj.name, obj);
            obj = new Button("btn_mybatis", "absolute", null, "3", "124", "25", "3", null, this.div_search);
            obj.set_taborder("31");
            obj.set_text("조회(Mybatis)");
            obj.set_cssclass("btn_WF_Search");
            this.div_search.addChild(obj.name, obj);
            obj = new Button("Button01", "absolute", null, "3", "108", "25", "131", null, this.div_search);
            obj.set_taborder("32");
            obj.set_text("조회(Ibatis)");
            obj.set_cssclass("btn_WF_Search");
            this.div_search.addChild(obj.name, obj);
        ...
        ***********************************************************************************/
        ...
        this.fn_search = function(obj,e)
        {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = application.services["svcurl"].url + "/selectSampleListWithVo.do";
         ...
         * @example
         */
        this.fn_search_mybatis = function(obj,e)
        {
        	// 조회조건(Condition)
            this.ds_search.setColumn(0, "searchCondition", this.div_search.cmb_searchCondition.value);
        	this.ds_search.setColumn(0, "searchKeyword"  , this.div_search.edt_searchKeyword.value);
            ...
            var strSvcId    = "search";
        	var strSvcUrl   = application.services["svcurl"].url + "/sampleMybatisSelectMap.do";
        	var inData      = "ds_search=ds_search";
        	var outData     = "ds_list=output1";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        {
            var strSvcId    = "save";
        	var strSvcUrl   = application.services["svcurl"].url + "/updateSampleDataWithVo.do";
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.btn_mybatis.addEventHandler("onclick", this.fn_search_mybatis, this);
            this.div_search.Button01.addEventHandler("onclick", this.fn_search, this);
